"""
Django settings for WellVibeWebAPI project.
...
EMAIL_FILE_PATH = oeg("EMAIL_FILE_PATH", "/tmp/WellVibeWeb-messages")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "WellVibeWebAPI",
    "DESCRIPTION": "API for WellVibeWeb",
    "VERSION": "1.0",
