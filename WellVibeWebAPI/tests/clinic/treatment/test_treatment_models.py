...
@pytest.mark.parametrize(
    ...
    (
        (
            "visit_instances",
            "Visit 1 (01.12.2024, 10:00) - Patient: Test Patient (99081112341), Doctor: Test Doctor (1000041)",
        ),
        (
            "prescription_instances",
            "Prescription 1 ([issue_date] - [expiry_date]) - Patient: Test Patient (99081112341), Doctor: Test Doctor (1000041)",
        ),
    ),
)
def test_role_str_representation(request, instances, expected_str):
