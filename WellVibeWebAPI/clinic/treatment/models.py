...
class Visit(BaseModel):
    ...
    def __str__(self):
        ...
        return f"Visit {self.readable_id} ({date_str}) - {patient_str}, {doctor_str}"
...
class Prescription(BaseModel):
    ...
    def __str__(self):
        ...
        return f"Prescription {self.readable_id} ({issue_date_str} - {expiry_date_str}) - {patient_str}, {doctor_str}"
...
class Dosage(models.Model):
    medicine = models.ForeignKey(
        "Medicine", on_delete=models.CASCADE, verbose_name=_("medicine")
    )
