...
class MedicineIngredient(models.Model):
    medicine = models.ForeignKey(
        Medicine, on_delete=models.PROTECT, verbose_name=_("medicine")
    )
...
class Office(BaseModel):
    office_type = models.ForeignKey(
        OfficeType, on_delete=models.PROTECT, verbose_name=_("room type")
    )
    ...
    def __str__(self):
        return f"{self.office_type} (Floor: {self.floor})"
